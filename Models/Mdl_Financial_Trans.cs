...
{
    public class Mdl_Financial_Trans
    {
        ...
        public string? EXT_TRX_ID { get; set; } = "";
        ...
        public string? PROCESSED_8300_YN { get; set; } = "";
        ...
        public string? EXT_SYS_RESULT_MSG { get; set; } = "";
        ...
        public string? GP_AWARD_CODE { get; set; } = "";
        public string? ORG_POSTED_AMOUNT { get; set; } = "";
        public string? INC_TAX_DEDUCTED_YN { get; set; } = "";
        public string? GP_AWARD_CANCELLED_YN { get; set; } = "";
        public string? GP_AWARD_CANCEL_CODE { get; set; } = "";
        public string? CC_REFUND_POSTING { get; set; } = "";
        public string? ELECTRONIC_VOUCHER_NO { get; set; } = "";
        public string? ROOM_NTS_EFFECTIVE { get; set; } = "";
        public string? SERVICE_RECOVERY_ADJUSTMENT_YN { get; set; } = "";
        public string? SERVICE_RECOVERY_DEPT_CODE { get; set; } = "";
        ...
        public string? PAYMENT_SURCHARGE_AMT { get; set; } = "";
        public string? PAYMENT_SURCHARGE_TYPE { get; set; } = "";
