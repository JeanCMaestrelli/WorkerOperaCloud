...
{
    public class Resort_Rate_ClassesJob : IServiceJobs
    {
        private readonly ILogger<Resort_Rate_ClassesJob> _logger;
        ...
        public Resort_Rate_ClassesJob(ILogger<Resort_Rate_ClassesJob> logger, DapperContext context, IConfiguration config, Job_Exec Job_Exec)
        {
            _logger = logger;
            _context = context;
            _Job_Exec = Job_Exec;
        ...
        public void IntegrarJobAsync(string filePath, string id_job, string TIPO_AGENDAMENTO)
        {
            ...
            var List = _Job_Exec.Get_List<Mdl_Resort_Rate_Classes>(filePath, LoggBuilder);
                ...
                try
                {
                    ...
                    foreach (var trial in List)
                    {
                        ...
                        try
                        {
                            ...
                            var result = command.Connection.Query<Mdl_Resort_Rate_Classes>(query);
        ...
        private OracleCommand MountParametros(OracleCommand parametros, Mdl_Resort_Rate_Classes Trxs_Codes)
        {
            ...
            parametros.Parameters.Add("RESORT_RESORT", Trxs_Codes.RESORT_RESORT);
