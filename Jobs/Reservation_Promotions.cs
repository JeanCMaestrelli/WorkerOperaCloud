...
{
    public class Reservation_Promotions : IServiceJobs
    {
        private readonly ILogger<Reservation_Promotions> _logger;
        ...
        public Reservation_Promotions(ILogger<Reservation_Promotions> logger, DapperContext context, IConfiguration config, Job_Exec Job_Exec)
        {
            _logger = logger;
            _context = context;
            _Job_Exec = Job_Exec;
        ...
        public void IntegrarJobAsync(string filePath, string id_job, string TIPO_AGENDAMENTO)
        {
            ...
            var List = _Job_Exec.Get_List<Mdl_Reservation_Promotions>(filePath, LoggBuilder);
                ...
                try
                {
                    ...
                    foreach (var trial in List)
                    {
                        ...
                        try
                        {
                            ...
                            var result = command.Connection.Query<Mdl_Reservation_Promotions>(query);
        ...
        private OracleCommand MountParametros(OracleCommand parametros, Mdl_Reservation_Promotions Trxs_Codes)
        {
            parametros.Parameters.Add("RESORT", Trxs_Codes.RESORT);
            parametros.Parameters.Add("RESV_NAME_ID", Trxs_Codes.RESV_NAME_ID);
            parametros.Parameters.Add("PROMO_CODE", Trxs_Codes.PROMO_CODE);
