...
{
    public class Resorts_MarketsJob : IServiceJobs
    {
        private readonly ILogger<Resorts_MarketsJob> _logger;
        ...
        public Resorts_MarketsJob(ILogger<Resorts_MarketsJob> logger, DapperContext context, IConfiguration config, Job_Exec Job_Exec)
        {
            _logger = logger;
            _context = context;
            _Job_Exec = Job_Exec;
        ...
        public void IntegrarJobAsync(string filePath, string id_job, string TIPO_AGENDAMENTO)
        {
            ...
            var List = _Job_Exec.Get_List<Mdl_Resorts_Markets>(filePath, LoggBuilder);
                ...
                try
                {
                    ...
                    foreach (var trial in List)
                    {
                        ...
                        try
                        {
                            ...
                            var result = command.Connection.Query<Mdl_Resorts_Markets>(query);
        ...
        private OracleCommand MountParametros(OracleCommand parametros, Mdl_Resorts_Markets Trxs_Codes)
        {
