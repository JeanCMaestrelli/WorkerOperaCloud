...
{
    public class Markets_GroupsJob : IServiceJobs
    {
        private readonly ILogger<Markets_GroupsJob> _logger;
        ...
        public Markets_GroupsJob(ILogger<Markets_GroupsJob> logger, DapperContext context, IConfiguration config, Job_Exec Job_Exec)
        {
            _logger = logger;
            _context = context;
            _Job_Exec = Job_Exec;
        ...
        public void IntegrarJobAsync(string filePath, string id_job, string TIPO_AGENDAMENTO)
        {
            ...
            var List = _Job_Exec.Get_List<Mdl_Markets_Groups>(filePath, LoggBuilder);
        ...
        private OracleCommand MountParametros(OracleCommand parametros, Mdl_Markets_Groups Trxs_Codes)
        {
            parametros.Parameters.Add("MARKET_GROUP", Trxs_Codes.MARKET_GROUP);
