...
{
    public class Resort_Room_ClassesJob : IServiceJobs
    {
        private readonly ILogger<Resort_Room_ClassesJob> _logger;
        ...
        public Resort_Room_ClassesJob(ILogger<Resort_Room_ClassesJob> logger, DapperContext context, IConfiguration config, Job_Exec Job_Exec)
        {
            _logger = logger;
            _context = context;
            _Job_Exec = Job_Exec;
        ...
        public void IntegrarJobAsync(string filePath, string id_job, string TIPO_AGENDAMENTO)
        {
            ...
            var List = _Job_Exec.Get_List<Mdl_Resort_Room_Classes>(filePath, LoggBuilder);
                ...
                try
                {
                    ...
                    foreach (var trial in List)
                    {
                        ...
                        try
                        {
                            ...
                            var result = command.Connection.Query<Mdl_Resort_Room_Classes>(query);
        ...
        private OracleCommand MountParametros(OracleCommand parametros, Mdl_Resort_Room_Classes Trxs_Codes)
        {
